...
一个用于推送好友生日及好友纪念日的 Telegram Bot。详见我的博客：[Telegram及Telegram-bot使用指南.html](https://www.eula.club/Telegram及Telegram-bot使用指南.html)
...
CREATE TABLE `push_content` (
  ...
  `persion` varchar(255) DEFAULT NULL COMMENT '有关的人',
  `day` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '实际日期',
  `memorial` varchar(255) DEFAULT NULL COMMENT '纪念日',
